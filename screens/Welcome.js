      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Block>
            ...
            />
            <Text h2 center bold>{item.title}</Text>
          </Block>
        )}
...
Welcome.defaultProps = {
  illustrations: [
    {
      id: 1,
      source: require("../assets/images/buy_a_home.jpg"),
      title: "Buy a home",
    },
    {
      id: 2,
      source: require("../assets/images/sell_a_home.jpg"),
      title: "Sell a home",
    },
    {
      id: 3,
      source: require("../assets/images/rent_a_home.jpg"),
      title: "Rent a home",
    }
  ]
};
